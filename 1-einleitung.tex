...
\begin{description}
	...
	\item[Fehlertoleranz] Fehler ab zu fangen macht ein gutes System aus. Häufige Fehlannahmen:
		...
		\end{itemize}
	\item[Transparenz] Benutzer ist nicht Bewusst, dass er auf einem Verteilten System arbeitet, sieht ein einfacheres Bild. Siehe auch \Cref{table:transparenztypen}
		\begin{table}[h]
